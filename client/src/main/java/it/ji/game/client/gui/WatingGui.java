...
public class WatingGui extends javax.swing.JFrame implements ClientListener {
    ...
    public void userAccepted(String serverId, String username) {
        LoggerG.setMessage("[DEBUG][EVENT] User accepted: " + username).system();
    ...
    public void serverIsAlive(boolean isAlive, Optional<String> serverId) {
        if (isAlive) {
//            LoggerG.setMessage("[DEBUG][GUI] Server is alive").system();
...
//            LoggerG.setMessage("[ERROR][GUI] Server is offline").system();
    ...
    private void nameFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nameFieldActionPerformed
        LoggerG.setMessage("nameFieldActionPerformed").system();
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    LoggerG.setMessage("[ERROR] FlatDarkLaf non trovato").system();
                }
