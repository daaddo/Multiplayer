...
public class TurretManager {
    ...
    public long insertNewBullet(Coordinates coordinates){
        ...
        LoggerG.setMessage("[DEBUG] Inserted new bullet with id: " + id + " at coordinates: " + coordinates.x() + " " + coordinates.y()).system();
        return id;
    }
    ...
    public void notifyBulletDeleted(long id){
        LoggerG.setMessage("[DEBUG] Notifying bullet deleted with id: " + id).system();
        bulletsId.remove(id);
    ...
    public void removeBulletFromMap(long id){
        LoggerG.setMessage("[DEBUG] Removed bullet with id: " + id + " at coordinates: " + bulletsId.get(id).x() + " " + bulletsId.get(id).y()).system();
        bulletsId.remove(id);
    }
}
